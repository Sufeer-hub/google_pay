...
import 'package:google_pay/my_recharge/recharge_successfull.dart';
import 'package:google_pay/view/home/payments/payment_successfull.dart';

class UpiPinRechargeScreen extends StatefulWidget {
  const UpiPinRechargeScreen({super.key});

  @override
  State<UpiPinRechargeScreen> createState() => _UpiPinRechargeScreenState();
}

class _UpiPinRechargeScreenState extends State<UpiPinRechargeScreen> {
  ...
  void _onCheckPressed() {
    if (_hiddenController.text.length == pinLength) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const RechargeSuccessfull()),
      );
    }
  }
