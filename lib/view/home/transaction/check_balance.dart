...
class _CheckBalanceState extends State<CheckBalance> {
  ...
  void _onCheckPressed() {
    if (_hiddenController.text.length == pinLength) {
      Navigator.push(context, MaterialPageRoute(builder: (_) => BankBalance()));
    }
  }
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          Text(
                            "UPI PIN will keep your account secure from unauthorized\naccess.Do not share this PIN with anyone",
